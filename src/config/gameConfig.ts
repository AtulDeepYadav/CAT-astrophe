/** Portrait canvas sized like a phone viewport; Phaser Scale.FIT letterboxes it on other aspect ratios. */
...
/** Score / next-cat preview section at the top of the panel. */
export const STATS_BAR_HEIGHT = 90;
